...
bgcolorClasses = ["bg-default", "bg-primary", "bg-secondary", "bg-success", "bg-danger", "bg-warning", "bg-info", "bg-light", "bg-dark", "bg-white"]
...
Vvveb.ComponentsGroup['Bootstrap 4'] =
["html/container", "html/gridrow", "html/heading", "html/Icon", "html/image", "html/jumbotron", "html/alert", "html/card", "html/badge", "html/listgroup", "html/hr", "html/taglabel", "html/navbar", "html/breadcrumbs", "html/table", "html/paragraph", "html/link", "html/video", "html/YoutubeVideo", "html/YoutubeVideoiframe", "html/button", "html/btn_icon", "html/btn_image"];

// Vvveb.ComponentsGroup['Buttons'] =
// ["html/default", "html/buttongroup","html/btn_primary", "html/btn_secondary", "html/btn_success", "html/btn_danger", "html/btn_warning", "html/btn_info", "html/btn_light", "html/btn_dark", "html/btn_small", "html/btn_large", "html/btn_block", "html/btn_outline", "html/btn_round","html/btn_icon", "html/btn_image" ];

// Vvveb.ComponentsGroup['Shapes / Icons'] =
// ["html/icon_home", "html/icon_play", "html/icon-angle-double-down", "html/icon-angle-double-up", "html/icon-angle-double-left", "html/icon-angle-double-right", "html/icon-angle-up", "html/icon-angle-down", "html/icon-angle-left", "html/icon-angle-right"];

// Vvveb.ComponentsGroup['Headings'] =
// ["html/heading1"];
...
Vvveb.Components.extend("_base", "html/container", {
    ...
    html: '<div class="container bg-default" style="min-height:150px;"><div class="m-5">Container</div></div>',
    name: "Container",
    properties: [
     {
        name: "Type",
...
Vvveb.Components.extend("_base", "html/buttongroup", {
    ...
    html: '<div class="btn-group" role="group" aria-label="Basic example"><a class="btn btn-secondary btn-sm text-center">Left</a><a class="btn btn-secondary btn-sm text-center">Middle</a><a class="btn btn-secondary btn-sm text-center">Right</a></div>',
	properties: [{
	    name: "Size",
        key: "size",
        htmlAttr: "class",
...
Vvveb.Components.extend("_base", "html/badge", {
    ...
    properties: [{
        ...
        key: "color",
        htmlAttr: "class",
        validValues:["badge-default", "badge-primary", "badge-secondary", "badge-success", "badge-danger", "badge-warning", "badge-info", "badge-light", "badge-dark"],
        inputtype: SelectInput,
        data: {
            options: [{
                value: "badge-default",
...
Vvveb.Components.extend("_base", "html/card", {
    ...
    name: "Card",
    html: '<div class="card">\
		  <img class="card-img-top" src="/static/plugins/vvvebjs/libs/builder/icons/image.svg" alt="Card image cap" width="128" height="128">\
		  <div class="card-body">\
			<h4 class="card-title">Card title</h4>\
			<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card\'s content.</p>\
			<a href="#" class="btn-primary btn-sm">Go somewhere</a>\
		  </div>\
		</div>'
});
...
Vvveb.Components.extend("_base", "html/jumbotron", {
    ...
    html: '<div class="jumbotron">\
		  ...
		  <p class="lead">\
			<a class="btn-primary btn-lg" href="#" role="button">Learn more</a>\
		  </p>\
		</div>'
});
...
Vvveb.Components.extend("_base", "html/video", {
    ...
    dragHtml: '<img  width="320" heigh' +
        't="240" src="' + Vvveb.baseUrl + 'icons/video.svg">',
...
Vvveb.Components.extend("_base", "html/YoutubeVideo", {
    nodes: ["video_section_thumbnail"],
    name: "Youtube Video",
    html: "<a data-lightbox=\"iframe\" style=\"background-image: url('/static/xsite_template/images/video_thumbnail.jpg');\" href=\"https://www.youtube.com/watch?v=NS0txu_Kzl8\" id=\"video_link\" class=\"video_section_thumbnail image_fade youtube_video_comp\">\n" +
        "                                <i class=\"fa fa-play\" style=\"position: absolute; top: 50%; left: 50%; font-size: 60px; color: #FFF; margin-top: -45px; margin-left: -23px\"></i>\n" +
        "                            </a>",
...
Vvveb.Components.extend("_base", "html/button", {
    ...
    html: '<a type="button" class="btn btn-default">Button</a>',
    properties: [{
        name: "Link To",
        key: "href",
        htmlAttr: "href",
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["btn-default", "btn-secondary", "btn-primary", "btn-info", "btn-success", "btn-danger", "btn-warning", "btn-info", "btn-light", "btn-dark", "btn-outline-primary","btn-outline-secondary", "btn-outline-info", "btn-outline-success", "btn-outline-danger", "btn-outline-warning", "btn-outline-info", "btn-outline-light", "btn-outline-dark", "btn-link"],
        data: {
            options: [{
                value: "btn-default",
                text: "Default"
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["btn-rounded", "btn-square", "btn-rounded-edges", "btn-rounded-leaf", "btn-rounded-leaf-reverse", "btn-oval", "btn-parallelogram"],
        data: {
            options: [{
                value: "btn-rounded",
                text: "Round"
                ...
                value: "btn-rounded-edges",
                text: "Rounded Edges"
            }, {
                value: "btn-rounded-leaf",
                text: "Rounded Leaf"
            }, {
                value: "btn-rounded-leaf-reverse",
                text: "Rounded Leaf Reverse"
            }, {
                value: "btn-oval",
                text: "Oval"
            }, {
                value: "btn-parallelogram",
                text: "Parallelogram"
            }]
        }
    }, {
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["btn-lg", "btn-sm", "btn-block"],
        data: {
            options: [{
                value: "",
                text: "Default"
...
Vvveb.Components.extend("_base", "html/btn_form", {
    nodes: ["button"],
    classes: ["button"],
    name: "Form Button",
    image: "icons/Form-Button.png",
...
Vvveb.Components.extend("_base", "html/btn_image", {
    classes: ["btn-active"],
    name: "Image Button",
    image: "icons/Image-Button.png",
    html: "<a class=\"btn-active btn\" style=\"background-image: url('/static/assets/images/favicon-96x96.png'); width: 50px; height: 50px; background-size: contain;background-repeat: no-repeat;\"></a>",
    properties: [{
        name: "Link To",
        key: "href",
        htmlAttr: "href",
        ...
        htmlAttr: "style",
        inputtype: SelectInput,
        validValues: ["", "url('/static/assets/images/favicon-96x96.png')"],
        data: {
            options: [{
                value: "",
                text: "default"
            }, {
                value: "url('/static/assets/images/favicon-96x96.png')",
                text: "Xsite Logo"
            }]
        }
    },{
...
Vvveb.Components.extend("_base", "html/btn_icon", {
    name: "Icon Button",
    image: "icons/Icon-Button.png",
    html: '<a class="btn btn-primary"><i class="fa fa-home"></i></a>'
});
...
Vvveb.Components.extend("_base", "html/Icon", {
    ...
    properties: [{
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["fa-home", "fa-play", "fa-angle-double-down", "fa-angle-double-left", "fa-angle-double-right", "fa-angle-double-up", "fa-angle-down", "fa-arrow-down", "fa-arrow-up", "fa-arrow-left", "fa-arrow-right", "fa-bars",
         "fa-angle-left", "fa-angle-right", "fa-angle-up", "fa-spinner", "fa-cog", "fa-envelope", "fa-phone", "fa-book-open", "fa-sticky-note","fa-globe", "fa-user", "fa-star", "fa-quote-left", "fa-quote-right", "fa-university", "fas fa-balance-scale-right"],
            data: {
                options: [{
                    value: "fa-home",
                    text: "home"
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["", "fa-xs", "fa-sm", "fa-lg", "fa-2x", "fa-3x", "fa-4x", "fa-5x", "fa-6x", "fa-7x", "fa-8x", "fa-9x", "fa-10x"],
        data: {
            options: [{
                value: "",
                text: "default"
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["fa-rotate-90", "fa-rotate-180", "fa-rotate-270", "fa-rotate-360"],
        data: {
            options: [{
                value: "fa-rotate-90",
                text: "90 degree"
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["", "fa-flip-horizontal", "fa-flip-vertical"],
        data: {
            options: [{
                value: "",
                text: "default"
...
Vvveb.Components.extend("_base", "html/Icon_fab", {
    classes: ["fab"],
    name: "Icon",
    image: "icons/Icon-List.png",
    html: '<i class="fa fa-home"></i>',
    properties: [{
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["fa-facebook-f", "fa-twitter", "fa-google-plus-g", "fa-pinterest", "fa-linkedin", "fa-instagram", "fa-youtube", "fa-black-tie"],
            data: {
                options: [{
                    value: "fa-facebook-f",
                    text: "facebook-f"
...
Vvveb.Components.extend("_base", "html/Icon_far", {
    classes: ["far"],
    name: "Icon",
    image: "icons/Icon-List.png",
    html: '<i class="fa fa-home"></i>',
...
Vvveb.Components.extend("_base", "html/counter", {
    image: "icons/heading.svg",
    name: "Heading",
    // nodes: ["h1", "h2","h3", "h4","h5","h6"],
